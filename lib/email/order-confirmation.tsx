...
<head>
  ...
  <style>
    ...
    .total-row { font-weight: bold; border-top: 2px solid #e5e7eb; padding-top: 10px; margin-top: 10px; }
    ...
    <div class="content">
      ...
      <div class="order-details">
        ...
        <table style="width: 100%;">
          ...
          <tr class="total-row"><td><strong>Total</strong></td><td align="right"><strong>$${total.toFixed(2)}</strong></td></tr>
        </table>
      </div>
